	...
	override function beatHit()
	{
		...
		if(!closedState) {
			switch (curBeat)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Mod'], -60);
				case 7:
					addMoreText('Release', -60);
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Collapse'); // credTextShit.text += '\nFunkin';
